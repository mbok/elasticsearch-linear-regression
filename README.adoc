...
interpreted as explanatory variables and the last as the response variable for computing the linear
regression and the statistics. The above request returns the following response:
