...
public class SamplingUtil {
   ...
   *
   * @param data sampling data to fill with observations
   ...
   */
  public static void fillWithObservations(SamplingData data, double[][] observations) {
    for (int i = 0; i < observations.length; i++) {
      data.sample(observations[i], observations[i][data.getFeaturesCount()]);
    }
  }
}
