...
public abstract class MultiValuesSourceParser<VS extends ValuesSource> implements
   ...
   */
  protected abstract MultiValuesSourceAggregationBuilder<VS, ?> createFactory(
   ...
   * @param otherOptions a {@link Map} of options to be populated by successive calls to this method
   * which will then be passed to the {@link #createFactory(String, ValuesSourceType, ValueType,
   * Map)} method
