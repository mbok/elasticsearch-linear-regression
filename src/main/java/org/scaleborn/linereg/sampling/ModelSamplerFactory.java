 ...
 */
public interface ModelSamplerFactory<C extends SamplingContext<C>> {

  C createContext(int featuresCount);

  ResponseVarianceTermSampler<?> createResponseVarianceTermSampler(C context);

  CoefficientLinearTermSampler<?> createCoefficientLinearTermSampler(C context);

  CoefficientSquareTermSampler<?> createCoefficientSquareTermSampler(C context);
}
